        ...
        <div>
            <form onSubmit={formData.handleSubmit} >
                <div className="form-control">
                    ...
                    <input type="text"
                        {...formData.getFieldProps('name')} id="name" name='name' />
                ...
                <div className="form-control">
                    ...
                    <input type="email"
                        {...formData.getFieldProps('email')} id="email" name='email' />
                    {formData.touched.email && formData.errors.email ? <div className="error">{formData.errors.email}</div> : <></>}
                </div>
                <div className="form-control">
                    <label htmlFor="channel">Channel</label>
                    <input type="text"
                        {...formData.getFieldProps('channel')} id="channel" name='channel' />
